    ...
    for obj_name in obj_names:
        ...
        for epoch in range(args.epochs):
            ...
            for i_batch, sample_batched in enumerate(dataloader):
                ...
                l2_loss = loss_l2(gray_rec,
                                  gray_batch)

                ssim_loss = loss_ssim(gray_rec,
                                      gray_batch)
...
if __name__=="__main__":
    ...
    obj_batch = [['capsule'],['bottle'],['carpet'],['leather'],['pill'], ['transistor'],['tile'],['cable'],['zipper'],
                 ['toothbrush'],['metal_nut'],['hazelnut'],['screw'],['grid'],['wood']]
    if int(args.obj_id) == -1:
        obj_list = ['capsule','bottle','carpet','leather','pill','transistor','tile',
